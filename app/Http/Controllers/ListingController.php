...
class ListingController extends Controller
{
    ...
    */
    ...
    { // e.g. Action: index, Verb: GET, URI: /listings, Route Name: listings.index
    ...
    {
        // Eager load the applications relationship
        $listing->load('applications'); // This loads the applications relationship
    ...
    {
        // Get the 'filter' parameter from the query string (default to 'all' if not present)
        $filter = $request->query('filter', 'all');  // Default to 'all' if no filter is passed
    
        // Fetch the listings that belong to the authenticated user
        $listings = auth()->user()->listings()->get(); 
    
        // Pass the listings and filter to the view
