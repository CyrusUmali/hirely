...
class UserController extends Controller
{
    ...
    public function showProfile($userId)
    {
      ...
      // Show the user settings page (view user info)
      ...
      // Render the edit form for user settings
      ...
      public function uploadCV(Request $request)
      {
          ...
          // Delete the existing CV if present
          if ($user->cv_path) {
          ...
          return redirect('/user/settings')->with('success', 'CV uploaded successfully!');
      }
      ...
      public function deleteCV()
      {
          ...
          if ($user->cv_path) {
              ...
              return redirect('/user/settings')->with('success', 'CV deleted successfully!');
          }
  
          return redirect('/user/settings')->with('error', 'No CV to delete.');
      }
      ...
      public function downloadCV()
      {
          ...
          if ($user->cv_path && Storage::exists($user->cv_path)) {
              return Storage::download($user->cv_path);
          }
  
          return redirect('/user/settings')->with('error', 'CV not found.');
      }
}