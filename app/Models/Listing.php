...
class Listing extends Model
{
    ...
    { // filtering the 'tags' and the Search <form>    // To define a Local Scope, prefix an Eloquent model method with 'scope' word    // this method is called by the filter() method inside index() method in ListingController.php
    ...
    { // A Listing `listings` belongs to a User `users`, and the Foreign Key of the Relationship is the `user_id` column
