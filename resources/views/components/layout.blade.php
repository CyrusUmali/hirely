...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="/"><img style="width: 200px;" src="{{ asset('images/hirely.png') }}" alt="" class="logo" /></a>
        <ul class="flex space-x-6 mr-6 text-lg">
            ...
            <li>
                <a href="/listings/manage" class="hover:text-laravel">
                    <i class="fa-solid fa-list-alt"></i> Manage Listings
                </a>
            </li>

            <li>
                <a href="/user/settings" class="hover:text-laravel">
    ...
    <footer style="background-color: #1ab394;"
        class="fixed bottom-0 left-0 w-full flex items-center justify-start font-bold bg-laravel text-white h-24 mt-24 opacity-90 md:justify-center">
        <!-- <p class="ml-2">Copyright &copy; 2022, All Rights reserved</p> -->

        <a
            href="/listings/create"
            class="absolute top-1/3 right-10 bg-blue-950 text-white py-2 px-5">Post Job</a>
    </footer>
